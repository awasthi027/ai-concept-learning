...
[the repo coding standards](../../rules/swift-coding-standards.md). Read that
file first — it is the source of truth. This skill defines the *procedure* and
the *output format*.
